            ...
            for filename1 in glob.glob('D:/FH/camera1/*'):
                for path1 in glob.glob(filename1 + '/*'):
                    ...
                    if name == 'Input0_Camera0.jpg':
                        ...
                        show1 = cv2.resize(show1, (650,410), interpolation = cv2.INTER_AREA)
                        ...
                        for i1 in range(len(model1.names)):
                            if values[f'{model1.names[i1]}_OK_1'] == True:
                                ...
                                if len_name1 != int(values[f'{model1.names[i1]}_Num_1']):
                                    ...
                                    t2 = time.time() - t1
                                    print(t2) 
                                    cv2.putText(show1, 'NG',(480,80),cv2.FONT_HERSHEY_COMPLEX, 3,(0,0,255),5)
                        ...
                        if myresult1 == 0:
                            ...
                            t2 = time.time() - t1
                            print(t2) 
                            cv2.putText(show1, 'OK',(480,80),cv2.FONT_HERSHEY_COMPLEX, 3,(0,255,0),5)
            ...
            for filename2 in glob.glob('D:/FH/camera2/*'):
                for path2 in glob.glob(filename2 + '/*'):
                    ...
                    if name == 'Input0_Camera0.jpg':
                        ...
                        show2 = cv2.resize(show2, (650,410), interpolation = cv2.INTER_AREA)
                        ...
                        for i2 in range(len(model2.names)):
                            if values[f'{model2.names[i2]}_OK_2'] == True:
                                ...
                                if len_name2 != int(values[f'{model2.names[i2]}_Num_2']):
                                    ...
                                    t2 = time.time() - t1
                                    print(t2) 
                                    cv2.putText(show2, 'NG',(480,80),cv2.FONT_HERSHEY_COMPLEX, 3,(0,0,255),5)
                        ...
                        if myresult2 == 0:
                            ...
                            t2 = time.time() - t1
                            print(t2) 
                            cv2.putText(show2, 'OK',(480,80),cv2.FONT_HERSHEY_COMPLEX, 3,(0,255,0),5)
            ...
            for filename3 in glob.glob('D:/FH/camera3/*'):
                for path3 in glob.glob(filename3 + '/*'):
                    ...
                    if name == 'Input0_Camera0.jpg':
                        ...
                        show3 = cv2.resize(show3, (650,410), interpolation = cv2.INTER_AREA)
                        ...
                        for i3 in range(len(model3.names)):
                            if values[f'{model3.names[i3]}_OK_3'] == True:
                                ...
                                if len_name3 != int(values[f'{model3.names[i3]}_Num_3']):
                                    ...
                                    t2 = time.time() - t1
                                    print(t2) 
                                    cv2.putText(show3, 'NG',(480,80),cv2.FONT_HERSHEY_COMPLEX, 3,(0,0,255),5)
                        ...
                        if myresult3 == 0:
                            ...
                            t2 = time.time() - t1
                            print(t2) 
                            cv2.putText(show3, 'OK',(480,80),cv2.FONT_HERSHEY_COMPLEX, 3,(0,255,0),5)
            ...
            for filename4 in glob.glob('D:/FH/camera4/*'):
                for path4 in glob.glob(filename4 + '/*'):
                    ...
                    if name == 'Input0_Camera0.jpg':
                        ...
                        show4 = cv2.resize(show4, (650,410), interpolation = cv2.INTER_AREA)
                        ...
                        for i4 in range(len(model4.names)):
                            if values[f'{model4.names[i4]}_OK_4'] == True:
                                ...
                                if len_name4 != int(values[f'{model4.names[i4]}_Num_4']):
                                    ...
                                    t2 = time.time() - t1
                                    print(t2) 
                                    cv2.putText(show4, 'NG',(480,80),cv2.FONT_HERSHEY_COMPLEX, 3,(0,0,255),5)
                        ...
                        if myresult4 == 0:
                            ...
                            t2 = time.time() - t1
                            print(t2) 
                            cv2.putText(show4, 'OK',(480,80),cv2.FONT_HERSHEY_COMPLEX, 3,(0,255,0),5)
            ...
            for path1 in glob.glob(filename1 + '/*'):
                ...
                if name == 'Input0_Camera0.bmp':
                    ...
                    for i1 in range(len(model.names)):
                        if values[f'{model.names[i1]}_OK_1'] == True:
                            len_name1 = 0
                            for name1 in names1:
                                if name1 == model.names[i1]:
                                    len_name1 +=1
                            if len_name1 != int(values[f'{model.names[i1]}_Num_1']):
                        ...
                        if values[f'{model.names[i1]}_NG_1'] == True:
...
def make_window(theme):
    ...
    layout_main = [
        ...
        #1
        sg.Frame('',[
            [sg.Image(filename='', size=(650,410),key='image1',background_color='black'),
        ...
        #2
        sg.Frame('',[
            [sg.Image(filename='', size=(650,410),key='image2',background_color='black'),
        ...
        #3
        sg.Frame('',[
            [sg.Image(filename='', size=(650,410),key='image3',background_color='black'),
        ...
        #4
        sg.Frame('',[
            [sg.Image(filename='', size=(650,410),key='image4',background_color='black'),
...
try:
    while True:
        ...
        #         650 = window['image1'].get_size()[0]
        #         410 = window['image1'].get_size()[1]
        #         480 = 650 - 190
        #         80 = 100 
        ...
        # program_camera1_FH_test(model=model1,size= 416,conf= values['conf_thres1']/100)
        # program_camera2_FH_test(model=model2,size= 416,conf= values['conf_thres2']/100)
        # program_camera3_FH_test(model=model3,size= 416,conf= values['conf_thres1']/100)
        # program_camera4_FH_test(model=model4,size= 416,conf= values['conf_thres2']/100)
        ...
        if event == 'Webcam1':
            ...
            imgbytes1 = cv2.resize(imgbytes1, (650,410), interpolation = cv2.INTER_AREA)
        ...
        if event == 'Webcam2':
            ...
            imgbytes2 = cv2.resize(imgbytes2, (650,410), interpolation = cv2.INTER_AREA)
        ...
        if event == 'Webcam3':
            ...
            imgbytes3 = cv2.resize(imgbytes3, (650,410), interpolation = cv2.INTER_AREA)
        ...
        if event == 'Webcam4':
            ...
            imgbytes4 = cv2.resize(imgbytes4, (650,410), interpolation = cv2.INTER_AREA)
        ...
        if recording1:
            if values['have_model1'] == True:
                ...
                img1_orgin = img1_orgin.copy()
                img1_orgin = cv2.cvtColor(img1_orgin, cv2.COLOR_BGR2RGB) 
                img1_resize = cv2.resize(img1_orgin,(650,410))
        ...
        if recording2:
            if values['have_model2'] == True:
                ...
                img2_orgin = img2_orgin.copy()
                img2_orgin = cv2.cvtColor(img2_orgin, cv2.COLOR_BGR2RGB) 
                img2_resize = cv2.resize(img2_orgin,(650,410))
        ...
        if recording3:
            if values['have_model3'] == True:
                ...
                img3_orgin = img3_orgin.copy()
                img3_orgin = cv2.cvtColor(img3_orgin, cv2.COLOR_BGR2RGB) 
                img3_resize = cv2.resize(img3_orgin,(650,410))
        ...
        if recording4:
            if values['have_model4'] == True:
                ...
                img4_orgin = img4_orgin.copy()
                img4_orgin = cv2.cvtColor(img4_orgin, cv2.COLOR_BGR2RGB) 
                img4_resize = cv2.resize(img4_orgin,(650,410))
        ...
        if event == 'Pic1':
            ...
            if dir_img1 not in ('',None):
                ...
                img1_resize = pic1.resize((650,410))
        ...
        if event == 'Pic2':
            ...
            if dir_img2 not in ('',None):
                ...
                img2_resize = pic2.resize((650,410))
        ...
        if event == 'Pic3':
            ...
            if dir_img3 not in ('',None):
                ...
                img3_resize = pic3.resize((650,410))
        ...
        if event == 'Pic4':
            ...
            if dir_img4 not in ('',None):
                ...
                img4_resize = pic4.resize((650,410))
